...
export default function CartPage() {
  ...
  // Set SEO metadata
  useEffect(() => {
    document.title = isAr ? "سلة التسوق - QIROX Cafe | اكتمل طلبك" : "Shopping Cart - QIROX Cafe";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', isAr 
        ? 'سلة التسوق الخاصة بك في QIROX Cafe - أضف المزيد من القهوة المفضلة وانتقل للدفع' 
        : 'Your shopping cart at QIROX Cafe - add more of your favorite coffee and proceed to checkout');
    }
  }, [isAr]);
