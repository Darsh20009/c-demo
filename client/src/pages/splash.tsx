  ...
  return (
    <div className="fixed inset-0 bg-[#0a0a0a] flex items-center justify-center z-50 overflow-hidden font-ibm-arabic">
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#2D9B6E] rounded-full blur-[120px]" />
      </div>
        ...
        {loading && (
          ...
          >
            ...
            <motion.div
              ...
              className="mb-16"
            >
              <img src={qiroxLogo} alt="QIROX" className="w-24 h-24 object-contain brightness-0 invert" />
            </motion.div>
