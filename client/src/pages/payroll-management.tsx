        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <Card className="bg-card border-border">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-muted-foreground text-xs">الموظفون</p>
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-muted-foreground text-xs">إجمالي الرواتب الأساسية</p>
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-muted-foreground text-xs">إجمالي الخصومات</p>
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-muted-foreground text-xs">صافي الرواتب</p>
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-muted-foreground text-sm">تقرير {MONTHS_AR[data.month - 1]} {data.year}</span>
            </div>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-3 flex-wrap gap-2">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-muted-foreground text-xs">أساسي: {emp.baseSalary.toLocaleString()}</p>
                        </div>
                      </div>
                      <div className="grid grid-cols-3 gap-3 mb-3 text-center">
                        ...
                        <div className="bg-card/50 rounded-lg p-2">
                          ...
                          <p className="text-muted-foreground text-xs">تأخير</p>
                        </div>
                      </div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-muted-foreground text-xs">نسبة الحضور</span>
